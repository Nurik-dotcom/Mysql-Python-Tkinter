...
def create_table():
    os.system('C:/Users/Нурдаулет/OneDrive/"Рабочий стол"/mysql.session/create_table_actor.py')
def show_table():
    os.system('C:/Users/Нурдаулет/OneDrive/"Рабочий стол"/mysql.session/show_table_actor.py')
def update_table():
    os.system('C:/Users/Нурдаулет/OneDrive/"Рабочий стол"/mysql.session/update_table_actor.py')
def insert_into():
    os.system('C:/Users/Нурдаулет/OneDrive/"Рабочий стол"/mysql.session/insert_into_actor.py')
def delete_table():
    os.system('C:/Users/Нурдаулет/OneDrive/"Рабочий стол"/mysql.session/delete_table_actor.py')
