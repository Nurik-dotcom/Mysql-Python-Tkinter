...
def create_table():
    os.system('C:/Users/Нурдаулет/OneDrive/"Рабочий стол"/mysql.session/create_table_director.py')
def show_table():
    os.system('C:/Users/Нурдаулет/OneDrive/"Рабочий стол"/mysql.session/show_table_director.py')
def update_table():
    os.system('C:/Users/Нурдаулет/OneDrive/"Рабочий стол"/mysql.session/update_table_director.py')
def insert_into():
    os.system('C:/Users/Нурдаулет/OneDrive/"Рабочий стол"/mysql.session/insert_into_director.py')
def delete_table():
    os.system('C:/Users/Нурдаулет/OneDrive/"Рабочий стол"/mysql.session/delete_table_director.py')
