...
with connection:
    with connection.cursor() as cursor:
        root = Tk()
        cursor.execute('create table Director(Id INT AUTO_INCREMENT PRIMARY KEY,Name VARCHAR(30) NOT NULL,Surname VARCHAR(20) NOT NULL,Age INT DEFAULT 0,Country varchar(40));')
        connection.commit()
